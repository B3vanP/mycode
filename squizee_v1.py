...
Authers: Bevan Aque Paraz and ChatGPT 4o
github.com/B3vanP
"""
...
class SquizeeApp:
    def __init__(self, root, questions):
        ...
        self.option_buttons = []
        for i in range(4):
            btn = tk.Radiobutton(root, text="", variable=self.options_var, value=i + 1, anchor="w", justify="left")
        ...
        self.restart_button = tk.Button(root, text="Start Quiz", command=self.start_quiz)
    ...
    def start_quiz(self):
        ...
        self.restart_button.config(text="Restart Quiz")
    ...
    def next_question(self):
        if self.current_question:
            ...
            user_answer = self.current_question['options'][selected_option - 1]
...
")
    ...
    def end_quiz(self):
        ...
        if messagebox.askyesno("Quiz Complete", "Would you like to:\n1. Answer more questions.\n2. Retry the questions you missed.\n3. Exit.", icon='question'):
